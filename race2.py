...
class Coin(pygame.sprite.Sprite):
    def __init__(self, enemy_pos):
        ...
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, SCREEN_WIDTH - 40), 0)
        self.weight = random.randint(1, 5)  # Different weights for coins
    ...
    def move(self):
        ...
        if self.rect.top > SCREEN_HEIGHT:
            ...
            COINS_COLLECTED += self.weight  # Increase coins collected based on weight
            self.rect.top = 0
            self.rect.center = (random.randint(40, SCREEN_WIDTH - 40), 0)
...
while True:
    ...
    for event in pygame.event.get():
        if event.type == INC_SPEED:
            ...
            E1.speed = ENEMY_SPEED  # Update enemy speed
            if COINS_COLLECTED >= N_COINS_TO_INCREASE_SPEED:
                N_COINS_TO_INCREASE_SPEED += 5  # Increase the number of coins needed to increase speed
