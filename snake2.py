...
def draw_food():
    if food:
        pygame.draw.rect(window, food[1], (food[0][0] * CELL_SIZE, food[0][1] * CELL_SIZE, CELL_SIZE, CELL_SIZE))
...
def generate_food():
    global food, last_food_time
    if food is None or pygame.time.get_ticks() - last_food_time > food_timer:
...
while running:
    ...
    # Generate new food after 3 seconds
    generate_food()
